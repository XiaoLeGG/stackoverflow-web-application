<template>
  <StatisticsContainer>
    <template v-slot:heading>
      <p>Answer Participation Distribution</p>
    </template>
    <template v-slot:introduction>
      <p>This diagram show the distribution of user participation in answer.</p>
    </template>
    ...
    <template v-slot:chart>
      <LineChart v-if="display_chart" ref="chart" title="Answer Participation"/>
    </template>
  </StatisticsContainer>
</template>
...
export default {
  ...
  methods: {
    onQuery() {
      ...
      axios.get("/api/user/post-answer-distribution", {
        params: {
