<template>
  <StatisticsContainer>
    <template v-slot:heading>
      <p>Comment Participation Distribution</p>
    </template>
    <template v-slot:introduction>
      <p>This diagram show the distribution of user participation in comment.</p>
    </template>
    ...
    <template v-slot:chart>
      <LineChart v-if="display_chart" ref="chart" title="Comment Participation"/>
    </template>
  </StatisticsContainer>
</template>
...
export default {
  ...
  methods: {
    onQuery() {
      ...
      axios.get("/api/user/post-comment-distribution", {
        params: {
